...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/30 12:55:32 by graiolo           #+#    #+#             */
/*   Updated: 2023/01/05 13:16:28 by graiolo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_launch_tricon(t_fractol *ptr)
{
	...
	while (++i < NUM_THREADS)
	{
		...
		pthread_create(&threads[i], NULL,
			ft_calculate_tricon, (void *)(&thread_datas[i]));
	}
	i = 0;
	while (i < NUM_THREADS)
